...
$jsonarray=array("values"=>array("FirstName"=>"Mario","UsediPad"=>$UsediPad));
$pkge=json_encode($jsonarray);

//The php curl instructions. Not sure all of them are necessary, but it works, so I'm not going
//to experiment.
    $ch = curl_init();  
